...
# ============================================================
# 六等分车道配置
# 画面分为6条垂直车道，中间两条车道合并，不掉落食材
# 左右各2条车道随机掉落小料
# ============================================================
NUM_LANES = 6  # 车道总数
LANE_WIDTH = SCREEN_WIDTH // NUM_LANES  # 每条车道宽度（像素）
MIDDLE_LANE_INDICES = [NUM_LANES // 2 - 1, NUM_LANES // 2]  # 中间两条车道索引（0-based，2和3）
INGREDIENT_LANE_INDICES = [0, 1, 4, 5]  # 掉落食材的车道（排除中间两条车道）
LANE_LINE_COLOR = (100, 100, 100, 40)  # 车道分割线颜色（半透明灰色）
...
# 以下三个配置已弃用：实际滤波参数由 bci/filter.py 中各类构造函数默认值控制
# DEAD_ZONE = 2  # [已弃用] 死区阈值
# SMOOTHING_FACTOR = 0.15  # [已弃用] 指数平滑因子
# FOCUS_SENSITIVITY = 100  # [已弃用] 焦点灵敏度
